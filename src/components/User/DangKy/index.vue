  ...
  <div class="auth-container user-theme">
    ...
    <div class="auth-card">
      <div class="brand">
        ...
        <p class="subtitle">Tạo tài khoản mới để tiếp tục</p>
      </div>
      ...
      <form @submit.prevent="handleSignup" class="auth-form">
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input v-model="nguoi_dung.ho_va_ten" type="text" id="fullname" placeholder="Nhập họ và tên của bạn" required>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input v-model="nguoi_dung.email" type="text" id="email" placeholder="Nhập email" required>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input v-model="nguoi_dung.password" :type="showPassword ? 'text' : 'password'" id="password"
      ...
      <div class="divider">
        <span>Đăng ký qua mạng xã hội</span>
      </div>
      ...
      <p class="switch-page">
        Đã có tài khoản? <router-link to="/user/login">Đăng nhập</router-link>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    handleSignup() {
      this.isLoading = true;
      axios.post('http://127.0.0.1:8000/api/auth/register', this.nguoi_dung)
        .then((res) => {
          if (res.data.status) {
